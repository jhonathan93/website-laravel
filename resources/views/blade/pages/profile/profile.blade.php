        ...
        <div class="max-w-5xl px-4 mx-auto -mt-24 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center pb-6 bg-white rounded-lg shadow-lg md:flex-row">
                ...
                <div class="mt-6 mb-4 ml-auto mr-6">
                    <button class="px-6 py-2 font-semibold text-white transition-all duration-300 bg-purple-600 rounded-full hover:bg-purple-700 hover:shadow-lg">
                        Seguir
                    </button>
                </div>
            </div>

            @include('blade.pages.profile.addresses.addresses',['addresses' => Auth::user()->addresses])
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="flex mt-2">
                                ...
                                <span class="px-2 py-1 ml-2 text-xs text-purple-800 bg-purple-100 rounded-full">Laravel</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="flex mt-2">
                                <span class="px-2 py-1 text-xs text-purple-800 bg-purple-100 rounded-full">React Native</span>
                                <span class="px-2 py-1 ml-2 text-xs text-purple-800 bg-purple-100 rounded-full">Node.js</span>
                            </div>
                        </div>
                    </div>
                </div>
